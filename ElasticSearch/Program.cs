...
namespace ElasticSearch
{
    class Program
    {
        static void Main(string[] parameters)
        {
            ...
            //Core bdinsert = new Core();
            //bdinsert.name = "'SV IQ Bot'";
            //bdinsert.status = "'DOWN'";
            //bdinsert.Insert(bdinsert.name, bdinsert.status);
            ...
            //var respSerialized = ser.WatsonDeserialize(response.ToString());
